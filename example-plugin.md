...
namespace Drupal\corp_migration_paragraphs\Plugin\migrate\source;

use Drupal\migrate\Row;
use Drupal\migrate_drupal\Plugin\migrate\source\d7\FieldableEntity;

/**
 * D7_section_title source.
 *
 * @MigrateSource(
 *   id = "d7_section_title",
 *   source_module = "corp_migration_paragraphs",
 * )
 */
class SectionTitle extends FieldableEntity {
